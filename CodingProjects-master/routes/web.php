...
// Big Boys Projects Routes
Route::prefix('insider')->middleware('verified')->group(function () {
    Route::get('/projects', 'ProjectController@index')->name('projects.index');
    Route::get('/projects/create', 'ProjectController@create')->name('projects.create');
    Route::post('/projects', 'ProjectController@store')->name('projects.store');
    Route::get('/projects/{id}', 'ProjectController@show')->name('projects.show');
    Route::post('/projects/{id}/comment', 'ProjectController@addComment')->name('projects.comment');
    Route::get('/projects/unlock', 'ProjectController@unlockAccess')->name('projects.unlock');
});
